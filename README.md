...
Continuous integrations running the unit-tests on GitHub are set up for x86_64 and arm64 platforms, Ubuntu-22.04, Ubuntu-24.04 and Windows, and, under QEMU user-mode emulation, for ppc64el, riscv64 and s390x, and the example for loong64. Pull requests to extend the [continuous integrations][18] to run the unit-tests on other architectures/platforms are most welcome.
